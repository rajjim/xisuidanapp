...
public class numhistory extends AppCompatActivity {
    ...
    public boolean onContextItemSelected(MenuItem paramMenuItem)
    {
        ...
        {
            map=listitem.get(i);
            db.execSQL("delete from memory where type = 'num' and date = '"+map.get("date")+"'");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btret.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(numhistory.this, num.class);
                numhistory.this.startActivity(intent);
                finish();
            }
        });
        ...
        Cursor cursor = this.db.query("memory", null, "type=?", new String[] { "num" }, null, null, null);
        int count = 0;
...
//            Toast.makeText(numhistory.this,map.toString(),Toast.LENGTH_LONG).show();
